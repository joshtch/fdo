// these files were once imported regressions and have been retired since.
...
describe('exports/export.cases.spec', function() {
  ...
  it('should solve 2016-06-11 twice', function() {
    var solver = new FDO({config: config_clone(case20160611)});
  ...
  it('should proceed past prepare for 2016-06-13', function() {
    ...
    var solver = new FDO({config: config_clone(config)});
  ...
  describe('2016-06-18', function() {
    ...
    it('should not take infinite time', function() {
      var solver = new FDO({config: config_clone(case20160618)});
  ...
  describe('2016-06-18.slim', function() {
    ...
    it('should not take infinite time', function() {
      var solver = new FDO({config: config_clone(case20160618_slim)});
    ...
    it('empty array version', function() {
      ...
      let solver = new FDO({config: config_clone(config)});
      solver.solve({log: 1, max: 1});
    });
  ...
  describe('2016-06-18.slim2', function() {
    ...
    it('should not take infinite time', function() {
      var solver = new FDO({config: config_clone(case20160618_slim2)});
  ...
  describe('2016-08-03', function() {
    ...
    it('should have three solutions', function() {
      var solver = new FDO({config: config_clone(case20160803)});
  ...
  describe('2016-08-03-2', function() {
    ...
    it('should solve quickly', function() {
      var solver = new FDO({config: config_clone(case201608032)});
  ...
  describe('2016-10-17', function() {
    ...
    it('should solve at all (regression)', function() {
      var solver = new FDO({config: config_clone(case20161017)});
