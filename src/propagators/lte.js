...
function propagator_lteStepWouldReject(domain1, domain2) {
  ...
  ASSERT_LOG(LOG_FLAG_PROPSTEPS, log => log('propagator_lteStepWouldReject;', domain__debug(domain1), '>?', domain__debug(domain2), '=>', domain_min(domain1), '>?', domain_max(domain2), '->', result));
  return result;
}
